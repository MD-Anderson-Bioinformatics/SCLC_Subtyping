...
#load in data with clinical follow up
data <- read.csv("clinical_data.csv")


#run the analysis for SCLC-A and SCLC-N
...
pdf(paste0(Sys.Date(), "_Classification_A_KM.pdf"), width = 5, height = 5)
ggsplot
dev.off()
...
pdf(paste0(Sys.Date(), "_Classification_N_KM.pdf"), width = 5, height = 5)
ggsplot
dev.off()
